...
;CoreUSB.c,161 :: 		void USB_Init_Desc(){
;CoreUSB.c,162 :: 		USB_config_dsc_ptr[0] = &configDescriptor1;
...
;CoreUSB.c,163 :: 		USB_string_dsc_ptr[0] = (const char*)&strd1;
	MOVLW       _strd1+0
...
;CoreUSB.c,164 :: 		USB_string_dsc_ptr[1] = (const char*)&strd2;
	MOVLW       _strd2+0
...
;CoreUSB.c,165 :: 		USB_string_dsc_ptr[2] = (const char*)&strd3;
	MOVLW       _strd3+0
