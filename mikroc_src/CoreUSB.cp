#line 1 "D:/ACADS/EE188/time/CoreUSB.c"
...
const struct{
 char bLength;
 char bDscType;
 unsigned int string[58];
 }strd2={
 118,
 0x03,
 {'M','i','n','d','a','n','a','o',' ','S','t','a','t','e',' ','U','n','i','v','e','r','s','i','t','y',' ','-',' ','I','l','i','g','a','n',' ','I','n','s','t','i','t','u','t','e',' ','o','f',' ','T','e','c','h','n','o','l','o','g','y'}
 };
...
const struct{
 ...
 42,
 0x03,
 {'H','a','r','d','w','a','r','e',' ','C','r','o','n',' ','D','e','v','i','c','e'}
 };
